...
export function Header() {
  return (
    <header className="w-full flex flex-row text-neutral-500 pt-2">
      ...
      <div>
        <h2 className="m-0 my-3 p-0 text-5xl text-tomato tracking-wider">
          A.R.I.A. <span className="text-3xl tracking-normal">(Aria)</span>
        </h2>
        <div className="m-0 mb-1 p-0 text-sm">Your AI Research Assistant</div>
        <div>
